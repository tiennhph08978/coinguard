...
<section class="home">
    <div class="container">
        <div class="columns">
            ...
            <div class="column is-6">
                <div class="pro">
                    <a href="/out/268" class="pro-image" target="_blank">
                        <img src="https://coinsniper.net/storage/images/hTIhQjr1SqJImW2BP4xaoUWDi4244TGdx0mflqzY.gif"
                            alt="" class="is-hidden-mobile">
                        <img src="https://coinsniper.net/storage/images/6Vr9xH4EKianVUYoT2ll4xm8LkYSwt1mNoDlvQOZ.gif"
                            alt="" class="is-hidden-tablet">
                    </a>
        ...
        <div class="message error light">
            <p>
                These projects are still in presale phase. Be careful when investing into presales - these projects are
                very new and scams can happen.
                For more information how to spot scams, please read our article <a href="/anti-scam-guide">How To Spot
                    Scams</a>.
            </p>
        </div>
            ...
            {{-- <div class="pages">
                ...
                <nav class="pagination is-centered" role="navigation" aria-label="pagination">
                    ...
                    <ul class="pagination-list">
                        ...
                        <li>
                            <a href="https://coinsniper.net/presales?page=2" class="pagination-link"
                                aria-label="Goto page 2">2</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/presales?page=3" class="pagination-link"
                                aria-label="Goto page 3">3</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/presales?page=4" class="pagination-link"
                                aria-label="Goto page 4">4</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/presales?page=5" class="pagination-link"
                                aria-label="Goto page 5">5</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/presales?page=6" class="pagination-link"
                                aria-label="Goto page 6">6</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/presales?page=7" class="pagination-link"
                                aria-label="Goto page 7">7</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/presales?page=8" class="pagination-link"
                                aria-label="Goto page 8">8</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/presales?page=9" class="pagination-link"
                                aria-label="Goto page 9">9</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/presales?page=10" class="pagination-link"
