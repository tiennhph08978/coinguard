...
<section class="home">
    <div class="container">
        <div class="columns">
            ...
            <div class="column is-6">
                <div class="pro">
                    <a href="/out/240" class="pro-image" target="_blank">
                        <img src="https://coinsniper.net/storage/images/ddc9f853-03fc-459b-bf9b-d57139e0adaa.gif" alt=""
                            class="is-hidden-mobile">
                        <img src="https://coinsniper.net/storage/images/e3d45dfe-ff03-4ed2-824e-d5c69d8117ca.gif" alt=""
            ...
            {{-- <div class="pages">
                ...
                <nav class="pagination is-centered" role="navigation" aria-label="pagination">
                    ...
                    <ul class="pagination-list">
                        ...
                        <li>
                            <a href="https://coinsniper.net/marketcap?page=2" class="pagination-link"
                                aria-label="Goto page 2">2</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/marketcap?page=3" class="pagination-link"
                                aria-label="Goto page 3">3</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/marketcap?page=4" class="pagination-link"
                                aria-label="Goto page 4">4</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/marketcap?page=5" class="pagination-link"
                                aria-label="Goto page 5">5</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/marketcap?page=6" class="pagination-link"
                                aria-label="Goto page 6">6</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/marketcap?page=7" class="pagination-link"
                                aria-label="Goto page 7">7</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/marketcap?page=8" class="pagination-link"
                                aria-label="Goto page 8">8</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/marketcap?page=9" class="pagination-link"
                                aria-label="Goto page 9">9</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/marketcap?page=10" class="pagination-link"
                                aria-label="Goto page 10">10</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/marketcap?page=11" class="pagination-link"
                                aria-label="Goto page 11">11</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/marketcap?page=12" class="pagination-link"
                                aria-label="Goto page 12">12</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/marketcap?page=13" class="pagination-link"
                                aria-label="Goto page 13">13</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/marketcap?page=14" class="pagination-link"
                        ...
                        <li>
                            <a href="https://coinsniper.net/marketcap?page=54" class="pagination-link"
                                aria-label="Goto page 54">54</a>
                        </li>
                        <li>
                            <a href="https://coinsniper.net/marketcap?page=55" class="pagination-link"
                                aria-label="Goto page 55">55</a>
                        </li>
